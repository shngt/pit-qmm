...
import sys
print(sys.path[0])
sys.path.append(sys.path[0].split('pit_qmm')[0])
print(sys.path)
...
class LazySupervisedDataset(Dataset):
    ...
    def __init__(self, data_path: str,
        ...
        self.pc_data_path = data_args.pc_data_path # '/scratch/09030/shngt/SJTU-PCQA/distortion'
...
#         return data_dict
    ...
    def _load_point_cloud(self, object_id, type='objaverse'):
        if type == 'objaverse':
            ...
            return self._load_objaverse_point_cloud_sp(object_id)
    ...
    def _load_objaverse_point_cloud_sp(self, object_id):
        ...
        for _ in range(self.num_pc_samples - 1): # range(self.num_pc_samples // 2): # 
        ...
        # for _ in range(1): # range(self.num_pc_samples // 2):
        #     idx = np.random.choice(point_cloud.shape[0])
        #     seed = point_cloud[idx].reshape(1, -1)
        #     _, indices = index.search(seed, 8192)
        #     sampled_pcs.append(point_cloud[indices[0]])
